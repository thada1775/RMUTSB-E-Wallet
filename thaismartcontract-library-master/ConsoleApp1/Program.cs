...
namespace ConsoleApp1
{
    ...
    class Program
    {
        ...
        static async Task Main()
        {
            ...
            var mycontracts = contractService.FindLocalContract("165dc1f670fb2c89046f47de718c4818d6c47fefa3ba152ed914fd82ae7b29f1");
            Console.WriteLine("TxId is:" + mycontracts.ID);
            Console.WriteLine("Name is:" + mycontracts.NameHex);
            Console.WriteLine("Token is:" + mycontracts.TokenHex);
            ...
            var walletContract = await contractService.FindContract("3ecb54e7c2551f27cf5944e386f05b27e1f0e4d7222d2cb2e8e784ef6560e30f"); //เตรียมรหัสสัญญา
            if(walletContract != null)
            {
                Console.WriteLine("dicover contract in blockchain");
            }
            else
            {
                Console.WriteLine("not dicover contract in blockchain");
            }
            //mycontracts = contractService.FindLocalContract();
